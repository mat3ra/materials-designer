...
Feature: Notebook healthcheck to create "BN(001)-BN(001), Interface"
  ...
  Scenario:
    ...
    # Open notebook
    When I double click on "create_twisted_interface_with_commensurate_lattices.ipynb" entry in sidebar
    And I see file "create_twisted_interface_with_commensurate_lattices.ipynb" opened
