...
Feature: Notebook healthcheck to create "Si(001), termination Si_P4/mmm_2, Slab, H-passivated"
  ...
  Scenario:
    ...
    # Open notebook
    When I double click on "passivate_slab.ipynb" entry in sidebar
    And I see file "passivate_slab.ipynb" opened
