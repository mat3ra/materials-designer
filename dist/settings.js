...
export const JUPYTERLITE_ORIGIN_URL = process.env.VITE_USE_JUPYTERLITE_DEV_URL === "true" ? JUPYTERLITE_DEVELOPMENT_URL : undefined; // if not set, will use the default URL
