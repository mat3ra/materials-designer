...
class HeaderMenuToolbar extends React.Component {
    ...
    renderViewMenu() {
        const { onSectionVisibilityToggle, isVisibleItemsList, isVisibleSourceEditor, isVisibleThreeDEditorFullscreen, isVisibleJupyterLiteSessionDrawer, isVisiblePythonReplPanel, } = this.props;
        return (_jsxs(ButtonActivatedMenuMaterialUI, { title: "View", children: [_jsxs(MenuItem, { onClick: () => this.setState({ showThreejsEditorModal: true }), children: [_jsx(ListItemIcon, { children: _jsx(ThreeDEditorIcon, {}) }), "Multi-Material 3D Editor"] }), _jsx(Divider, {}), _jsxs(MenuItem, { onClick: () => onSectionVisibilityToggle("ItemsList"), children: [_jsx(ListItemIcon, { children: isVisibleItemsList ? _jsx(VisibilityOffIcon, {}) : _jsx(VisibilityIcon, {}) }), "Sidebar"] }), _jsxs(MenuItem, { onClick: () => onSectionVisibilityToggle("SourceEditor"), children: [_jsx(ListItemIcon, { children: isVisibleSourceEditor ? _jsx(VisibilityOffIcon, {}) : _jsx(VisibilityIcon, {}) }), "Source Editor"] }), _jsxs(MenuItem, { onClick: () => onSectionVisibilityToggle("ThreeDEditorFullscreen"), children: [_jsx(ListItemIcon, { children: isVisibleThreeDEditorFullscreen ? (_jsx(VisibilityOffIcon, {})) : (_jsx(VisibilityIcon, {})) }), "3D Viewer/Editor"] }), _jsxs(MenuItem, { onClick: () => onSectionVisibilityToggle("JupyterLiteSessionDrawer"), children: [_jsx(ListItemIcon, { children: isVisibleJupyterLiteSessionDrawer ? _jsx(VisibilityOffIcon, {}) : _jsx(Terminal, {}) }), "JupyterLite Session"] }), _jsxs(MenuItem, { onClick: () => onSectionVisibilityToggle("PythonReplPanel"), children: [_jsx(ListItemIcon, { children: isVisiblePythonReplPanel ? _jsx(VisibilityOffIcon, {}) : _jsx(PythonReplIcon, {}) }), "Python REPL"] })] }));
    }
    renderAdvancedMenu() {
