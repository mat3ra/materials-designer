declare const MDMaterial_base: {
    ...
    prop<T_10 = undefined>(name: string, defaultValue: T_10): T_10;
    ...
    prop<T_3_1 = undefined>(name: string): T_3_1 | undefined;
    setProp(name: string, value: unknown): void;
    unsetProp(name: string): void;
    setProps(json?: import("@mat3ra/esse/dist/js/esse/types").AnyObject | undefined): any;
    toJSON(exclude?: string[] | undefined): import("@mat3ra/esse/dist/js/esse/types").AnyObject;
    ...
    prop<T_5_1 = undefined>(name: string): T_5_1 | undefined;
    setProp(name: string, value: unknown): void;
    unsetProp(name: string): void;
    setProps(json?: import("@mat3ra/esse/dist/js/esse/types").AnyObject | undefined): any;
    toJSON(exclude?: string[] | undefined): import("@mat3ra/esse/dist/js/esse/types").AnyObject;
    ...
    new (...args: any[]): {
        readonly isDefault: boolean;
        _json: import("@mat3ra/esse/dist/js/esse/types").AnyObject;
        prop<T_6_1 = undefined>(name: string, defaultValue: T_6_1): T_6_1;
        prop<T_7_1 = undefined>(name: string): T_7_1 | undefined;
        setProp(name: string, value: unknown): void;
        unsetProp(name: string): void;
        setProps(json?: import("@mat3ra/esse/dist/js/esse/types").AnyObject | undefined): any;
        toJSON(exclude?: string[] | undefined): import("@mat3ra/esse/dist/js/esse/types").AnyObject;
